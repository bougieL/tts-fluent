...
;(Taf.DataHelp = {
  ...
  (Taf.BinBuffer = function (t) {
    ;(this.buf = null),
      ...
      null != t &&
        ...
        ((this.buf = t.buf), (this.vew = new DataView(this.buf)), (this.len = t.length), (this.position = t.position)),
      null != t &&
        void 0 != t &&
        t instanceof ArrayBuffer &&
        ((this.buf = t), (this.vew = new DataView(this.buf)), (this.len = this.vew.byteLength), (this.position = 0)),
  ...
  (Taf.JceInputStream.prototype.skipField = function (t) {
    switch (t) {
      ...
      case Taf.DataHelp.EN_SIMPLELIST:
        var s = this.readFrom()
        if (s.type != Taf.DataHelp.EN_INT8) throw Error('skipField with invalid type, type value: ' + t + ',' + s.type)
  ...
  (Taf.JceInputStream.prototype.readStruct = function (t, e, i) {
    if (0 == this.skipToTag(t, e)) return i
    var r = this.readFrom()
    if (r.type != Taf.DataHelp.EN_STRUCTBEGIN) console.log('test3')
  ...
  (Taf.JceInputStream.prototype.readBytes = function (t, e, i) {
    ...
    if (r.type == Taf.DataHelp.EN_SIMPLELIST) {
      var n = this.readFrom()
      if (n.type != Taf.DataHelp.EN_INT8) throw Error('type mismatch, tag:' + t + ',type:' + r.type + ',' + n.type)
...
;(Taf.Util = Taf.Util || {}),
  (Taf.Util.jcestream = function (t) {
    ...
    for (var e = new Uint8Array(t), i = '', r = 0; r < e.length; r++)
      0 != r && r % 16 == 0 ? (i += '\n') : 0 != r && (i += ' '), (i += (e[r] > 15 ? '' : '0') + e[r].toString(16))
...
;(HUYA.EWebSocketCommandType = {
  ...
  (HUYA.WebSocketCommand.prototype.readFrom = function (t) {
    ;(this.iCmdType = t.readInt32(0, !1, this.iCmdType)), (this.vData = t.readBytes(1, !1, this.vData))
  }),
  ...
  (HUYA.WSRegisterRsp.prototype.writeTo = function (t) {
    t.writeInt32(0, this.iResCode), t.writeInt64(1, this.lRequestId), t.writeString(2, this.sMessage)
  }),
  ...
  (HUYA.UserEventRsp = function () {
    ;(this.lTid = 0), (this.lSid = 0), (this.iUserHeartBeatInterval = 60), (this.iPresentHeartBeatInterval = 60)
  }),
  ...
  (HUYA.VipListReq = function () {
    ;(this.tUserId = new HUYA.UserId()), (this.lTid = 0), (this.lSid = 0), (this.iStart = 0), (this.iCount = 0)
  }),
  ...
  (HUYA.UserChannelReq = function () {
    ;(this.tId = new HUYA.UserId()), (this.lTopcid = 0), (this.lSubcid = 0), (this.sSendContent = '')
  }),
  ...
  (HUYA.BadgeReq.prototype.readFrom = function (t) {
    ;(this.tUserId = t.readStruct(0, !1, this.tUserId)), (this.lBadgeId = t.readInt64(1, !1, this.lBadgeId))
  }),
  ...
  (HUYA.FansTips.prototype.readFrom = function (t) {
    ;(this.iType = t.readInt32(0, !1, this.iType)), (this.tBadgeInfo = t.readStruct(1, !1, this.tBadgeInfo))
  }),
  ...
  (HUYA.FansInfoNotice.prototype.writeTo = function (t) {
    t.writeInt32(0, this.iFansLevel), t.writeInt32(1, this.iGreenPopUpCount), t.writeStruct(2, this.tTips)
  }),
  ...
  (HUYA.FansRankListRsp = function () {
    ;(this.lBadgeId = 0), (this.sBadgeName = ''), (this.vFansRankItem = new Taf.Vector(new HUYA.FansRankItem()))
  }),
  ...
  (HUYA.FansRankListRsp.prototype.writeTo = function (t) {
    t.writeInt64(0, this.lBadgeId), t.writeString(1, this.sBadgeName), t.writeVector(2, this.vFansRankItem)
  }),
  ...
  (HUYA.GetLivingInfoReq = function () {
    ;(this.tId = new HUYA.UserId()), (this.lTopSid = 0), (this.lSubSid = 0), (this.lPresenterUid = 0)
  }),
  ...
  (HUYA.MultiStreamInfo = function () {
    ;(this.sDisplayName = ''), (this.iBitRate = 0), (this.iCodecType = 0), (this.iCompatibleFlag = 0)
  }),
  ...
  (HUYA.LiveProxyValue.prototype.readFrom = function (t) {
    ;(this.eProxyType = t.readInt32(0, !1, this.eProxyType)), (this.sProxy = t.readVector(1, !1, this.sProxy))
  }),
  ...
  (HUYA.GetVerificationStatusResp.prototype.readFrom = function (t) {
    ;(this.iStatus = t.readInt32(0, !1, this.iStatus)), (this.lExpenditure = t.readInt64(1, !1, this.lExpenditure))
  }),
  ...
  (HUYA.MuteRoomUserRsp.prototype.readFrom = function (t) {
    ;(this.iRetCode = t.readInt32(0, !1, this.iRetCode)), (this.sMsg = t.readString(1, !1, this.sMsg))
  }),
  (HUYA.DIYBigGiftEffect = function () {
    ;(this.sResourceUrl = ''), (this.sResourceAttr = ''), (this.sWebResourceUrl = ''), (this.sPCResourceUrl = '')
  }),
...
;(HUYA.SendItemNoticeWordBroadcastPacket = function () {
  ...
  (HUYA.EndLiveNotice.prototype.writeTo = function (t) {
    t.writeInt64(0, this.lPresenterUid), t.writeInt32(1, this.iReason), t.writeInt64(2, this.lLiveId)
  }),
  ...
  (HUYA.SenderItem = function () {
    ;(this.lSenderUid = 0), (this.lYYid = 0), (this.iSenderRole = 0), (this.iSenderGender = 0), (this.sSenderNick = '')
  }),
  ...
  (HUYA.NobleItem.prototype.readFrom = function (t) {
    ;(this.iNobleLevel = t.readInt32(0, !1, this.iNobleLevel)), (this.lDeadLine = t.readInt64(1, !1, this.lDeadLine))
  }),
  ...
  (HUYA.FansItem.prototype.writeTo = function (t) {
    t.writeInt32(0, this.iFansLevel), t.writeString(1, this.sFansNick), t.writeString(2, this.sFansPresenterNick)
  }),
  ...
  (HUYA.PropView = function () {
    ;(this.id = 0), (this.name = ''), (this.uids = new Taf.Map(new Taf.INT64(), new Taf.INT16())), (this.tips = '')
  }),
  ...
  (HUYA.PropView.prototype.writeTo = function (t) {
    t.writeInt32(0, this.id), t.writeString(1, this.name), t.writeMap(2, this.uids), t.writeString(3, this.tips)
  }),
  ...
  (HUYA.TokenCdnInfo.prototype.readFrom = function (t) {
    ;(this.sCdnName = t.readString(0, !1, this.sCdnName)), (this.sUrl = t.readString(1, !1, this.sUrl))
  }),
  ...
  (HUYA.CdnAntiCodeInfo.prototype.writeTo = function (t) {
    t.writeString(0, this.sCdnName), t.writeString(1, this.sFlvAntiCode), t.writeString(2, this.sHlsAntiCode)
  }),
  ...
  (HUYA.BatchGetCdnTokenReq.prototype.readFrom = function (t) {
    ;(this.vCdnInfos = t.readVector(0, !1, this.vCdnInfos)), (this.sStreamName = t.readString(1, !1, this.sStreamName))
  }),
...
;(HUYA.GetWebdbUserInfoReq = function () {
  ;(this.lUid = 0), (this.lImid = 0), (this.sPassport = ''), (this.sAccount = ''), (this.bCacheFirst = !0)
}),
  ...
  (HUYA.GiftInfo.prototype.readFrom = function (t) {
    ;(this.iItemType = t.readInt32(0, !1, this.iItemType)), (this.iItemCount = t.readInt32(1, !1, this.iItemCount))
  }),
  ...
  (HUYA.FinishTaskNoticeRsp.prototype.readFrom = function (t) {
    ;(this.iRspCode = t.readInt32(0, !1, this.iRspCode)), (this.iTaskId = t.readInt32(1, !1, this.iTaskId))
  }),
  ...
  (HUYA.ContentFormat.prototype.writeTo = function (t) {
    t.writeInt32(0, this.iFontColor), t.writeInt32(1, this.iFontSize), t.writeInt32(2, this.iPopupStyle)
  }),
  ...
  (HUYA.SenderInfo = function () {
    ;(this.lUid = 0), (this.lImid = 0), (this.sNickName = ''), (this.iGender = 0), (this.ic = '')
  }),
  ...
  (HUYA.UidNickName.prototype.readFrom = function (t) {
    ;(this.lUid = t.readInt64(0, !1, this.lUid)), (this.sNickName = t.readString(1, !1, this.sNickName))
  }),
  (HUYA.SendMessageFormat = function () {
    ;(this.iSenceType = 0), (this.lFormatId = 0)
  }),
  ...
  (HUYA.SendMessageFormat.prototype.writeTo = function (t) {
    t.writeInt32(0, this.iSenceType), t.writeInt64(1, this.lFormatId)
  }),
  (HUYA.SendMessageFormat.prototype.readFrom = function (t) {
    ;(this.iSenceType = t.readInt32(0, !1, this.iSenceType)), (this.lFormatId = t.readInt64(1, !1, this.lFormatId))
  }),
  ...
  (HUYA.Dimension.prototype.readFrom = function (t) {
    ;(this.sName = t.readString(0, !1, this.sName)), (this.sValue = t.readString(1, !1, this.sValue))
  }),
  ...
  (HUYA.MessageTagInfo.prototype.writeTo = function (t) {
    t.writeInt32(0, this.iAppId), t.writeString(1, this.sTag)
  }),
  (HUYA.MessageTagInfo.prototype.readFrom = function (t) {
    ;(this.iAppId = t.readInt32(0, !1, this.iAppId)), (this.sTag = t.readString(1, !1, this.sTag))
  }),
...
;(HUYA.WSRegisterGroupReq = function () {
  ;(this.vGroupId = new Taf.Vector(new Taf.STRING())), (this.sToken = '')
}),
  ...
  (HUYA.WSRegisterGroupReq.prototype.readFrom = function (t) {
    ;(this.vGroupId = t.readVector(0, !1, this.vGroupId)), (this.sToken = t.readString(1, !1, this.sToken))
  }),
...
;(HUYA.GetSequenceReq = function () {
  ;(this.tId = new HUYA.UserId()), (this.iSeqNum = 0), (this.iFromType = 0), (this.iBusinessType = 0), (this.sSgin = '')
}),
  ...
  (HUYA.GetSequenceRsp.prototype.writeTo = function (t) {
    t.writeInt32(0, this.iRetCode), t.writeString(1, this.sSeq)
  }),
  (HUYA.GetSequenceRsp.prototype.readFrom = function (t) {
    ;(this.iRetCode = t.readInt32(0, !1, this.iRetCode)), (this.sSeq = t.readString(1, !1, this.sSeq))
  })
